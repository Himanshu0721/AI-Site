  ...
  return (
    <footer className="bg-gray-800 text-white mt-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div>
            ...
            <p className="text-gray-400">
              TEN Artificial Intelligence is committed that offers a variety of AI tools.
            </p>
          </div>
          <div>
        ...
        >
          <p>&copy; {new Date().getFullYear()} TEN Artificial Intelligence. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
